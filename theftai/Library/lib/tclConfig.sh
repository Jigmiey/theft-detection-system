...
# installed.
TCL_PREFIX='E:/theft-detection/theftai\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/theft-detection/theftai\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/theft-detection/theftai\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/theft-detection/theftai\Library\include'
...
TCL_PACKAGE_PATH='E:/theft-detection/theftai\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/theft-detection/theftai\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/theft-detection/theftai\Library\lib\tclstub86.lib'
